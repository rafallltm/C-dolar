...
Este é um software para converter valores de Reais (BRL) para Dólares (USD). Ele utiliza a [ExchangeRate-API](https://www.exchangerate-api.com)  para obter taxas de câmbio.
